      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
        <div>
          <h1 className="text-3xl font-bold text-[#212121] flex items-center gap-2">
            ...
            {t('pages.student.notifications.title', 'My Notifications')}
          </h1>
          <p className="text-[#424242]">{t('pages.student.notifications.subtitle', 'View notifications from supervisors and system')}</p>
        </div>
